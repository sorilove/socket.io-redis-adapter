...
export abstract class ClusterAdapter extends Adapter {
  ...
  // by sorilove --------------->
  protected abstract postjoin(message);
  protected abstract postleave(message);
  protected abstract postdisconnect(message);
  // by sorilove <---------------
